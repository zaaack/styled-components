...
import type { DeferredInterpolation } from '../../types'
...
describe('flatten', () => {
  ...
  it('defers functions', () => {
    const func: DeferredInterpolation = () => 'bar'
    const funcWFunc: DeferredInterpolation = () => ['static', subfunc => subfunc ? 'bar' : 'baz']
  ...
  it('passes values to function', () => {
    const func: DeferredInterpolation = ({ bool }) => bool ? 'bar' : 'baz'
  ...
  it('recursively calls functions', () => {
    const func: DeferredInterpolation = () => ['static', ({ bool }) => bool ? 'bar' : 'baz']
